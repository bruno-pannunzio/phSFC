...
- **`supp_figure5_notebook.ipynb` to `supp_figure9_notebook.ipynb`**: Modular notebooks dedicated to the supplementary figures. These reproduce specialized analyses such as 3D spectral visualizations, cross-platform (SFC vs. HSI) comparisons, and lipid trajectory modeling.
